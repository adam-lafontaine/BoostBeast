...
public:
	...
	void on_read(beast::error_code ec, std::size_t bytes_transferred)
	{
		...
		std::cout << "Server sent: " << beast::make_printable(buffer_.data()) << std::endl;
...
void websocket_client_async()
{
	...
	auto const text = "Hello from async client";
